    ...
    return (
        <Layout>
            ...
            <Container>
                ...
                <br></br>                
                <User 
                excerpt="I'm an avid jigsaw puzzle solver, chocolate consumer, standup comedy fan, shower singer, and aspiring software engineer.
                ...
                I also have a malti-poo named Tootoo who loves to code with me (or step on my keyboard, either works) - try to tell us apart!" 
                avatar={PG}
                image={TootooTable}
                />
